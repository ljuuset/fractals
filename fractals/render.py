...
from roots import cases, find_roots

resolution = 1000
maxiter = 100
tol = 1e-15

def render_fractal(case, method=newton, resolution=resolution, maxiter=maxiter, tol=tol):
